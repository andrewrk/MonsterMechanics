...
METADATA = {
    ...
    'author':           '',
    #'author_email':     '',
    'url':              'http://pyweek.org/e/MonsterMechanics',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'MonsterMechanics': 'MonsterMechanics',
                   },
    'packages': ['MonsterMechanics', ],
}
...
_DATA_DIR = os.path.join('MonsterMechanics', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'MonsterMechanics': data_dirs}
...
src = []
add_files(src,os.walk('MonsterMechanics'))
